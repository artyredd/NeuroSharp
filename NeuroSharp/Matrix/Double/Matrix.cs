...
namespace NeuroSharp.Double
{
    public class Matrix : BaseMatrix<double>, IMatrix<double>
    {
        /// <summary>
        ...
        /// <see cref="Matrix"/>
        /// </returns>
        public Matrix(int Rows, int Columns, Func<double> T_Delegate) : base(Rows, Columns, T_Delegate) => AssignOperations();
        ...
        /// <see cref="Matrix"/>
        /// </returns>
        public Matrix(int Rows, int Columns, Func<int, double> T_DelegateUsingRowIndex) : base(Rows, Columns, T_DelegateUsingRowIndex) => AssignOperations();
        ...
        /// <see cref="Matrix"/>
        /// </returns>
        public Matrix(int Rows, int Columns, Func<int, int, double> T_DelegateUsingIndices) : base(Rows, Columns, T_DelegateUsingIndices) => AssignOperations();
        ...
        /// <see cref="Matrix"/>
        /// </returns>
        public Matrix(int Rows, int Columns, double DefaultValue) : base(Rows, Columns, DefaultValue) => AssignOperations();
        ...
        /// <see cref="Matrix"/>
        /// </returns>
        public Matrix(int Rows, int Columns, IEnumerable<double> Enumerable, int? MaxEnumeration = null) : base(Rows, Columns, Enumerable, MaxEnumeration) => AssignOperations();
        ...
        /// <see cref="Matrix"/>
        /// </returns>
        public Matrix(int Rows, int Columns, Span<double> Values, bool AsEnumerable) : base(Rows, Columns, Values, AsEnumerable) => AssignOperations();

        public override OperationSet<double, double> DoubleOperations => SameTypedOperations;
        ...
        private void AssignOperations()
        {
            SameTypedOperations = new()
            {
                ...
                TwoRefenceAdder = (ref double Left, ref double Right) => Left += Right,
                TwoRefenceSubtractor = (ref double Left, ref double Right) => Left -= Right,
                TwoReferenceMultiplier = (ref double Left, ref double Right) => Left *= Right,
            };
